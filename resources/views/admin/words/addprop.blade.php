                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> خصائص أخري للكلمة  </a>
                                </li>
                                <li class="breadcrumb-item active">  إضافة خصائص أخري للكلمة
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.words.addprop',['id'=>$word->word_id,'mojjam_id'=>$mojjam->id])}}"
                                              method="POST">
                                              {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="" id="other_word_properties[]"
                                                                           class="form-control"
                                                                           placeholder="  "
