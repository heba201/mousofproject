                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">   الفوائد اللغوية
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">   فوائد لغوية  </h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="faeda_subject_id" class="select2 form-control" id="selectId" disabled>
                                                                        <optgroup label=" موضوع الفائدة ">
                                                                            @foreach($fawaedsubjects as $subject)
                                                                                    <option value="{{$subject->id}}" {{$fawaed->faeda_subject_id==$subject->id ? 'selected' : ''}}>{{$subject->faeda_subject}}</option>
                                                                                @endforeach
                                                                        </optgroup>
                                                                    </select>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    @foreach($faedarow as $faedatext)
                                                                    <textarea type="text" value="" id="faeda[]"
                                                                           class="form-control" style="margin-bottom: 10px;"
                                                                           placeholder="  " readonly
                                                                           name="faeda[]">{{$faedatext}}</textarea>
                                                                           @endforeach
                                                                    @error("faeda.*")
                                                                    <span class="text-danger">{{$message}}</span>
                                                                    @enderror
