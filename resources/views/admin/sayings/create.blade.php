                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> إضافة قول مأثور
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  إضافة  قول مأثور</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.sayings.createforcharacter',$character->id)}}"
                                              method="POST" enctype="multipart/form-data">
                                              {{ csrf_field() }}
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> إضافة قول مأثور للشخصية </h4>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="projectinput1">  الشخصية </label>
                                                                    <input type="text" value="{{$character->character_name}}" id="character"
      ...
      $(document).ready(function(){
        $('#add_button').click(function(){
            $('.field-wrapper').append(
                '<div class="col-md-5" id="GFG_DIV"><textarea type="text" value="" id="saying[]" class="form-control" placeholder=" " name="saying[]" style="margin-bottom:15px"></textarea></div>'
             );
})
