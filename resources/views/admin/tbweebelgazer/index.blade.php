        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  تبويب جذر الكلمة </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">الرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active">   تبويب جذور الكلمات
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">تبويب جذور الكلمات </h4><br>
                                    @if( Auth::user()->role_id==2)
                                    <h4 class="card-title">
                                        <a href="{{route('admin.tabweebelgazer.create',['word_id'=>$word->word_id,'mojjam_id'=>$word->mojjam_id])}}"
                                            class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1"><i class="fas fa-plus-circle" style="color: white"></i> إضافة  خصائص الكلمة حسب جذر </a>
                                    </h4>
                                    @endif
