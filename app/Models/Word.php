...
class Word extends Model
{
    ...
    protected $fillable = ['word','word_type','admin_id','gzer_type','gzer_weight','weight_indication','other_word_properties',
    'word_source','word_indication','word_derivatives','search_no','word_gzer','created_at','updated_at'];
    public function scopeSelection($query)
    {

        return $query->select('id','word','word_type','admin_id','gzer_type','gzer_weight','gzer_indication','weight_indication','word_source','word_indication','word_derivatives','search_no','word_gzer','other_word_properties');
    }
