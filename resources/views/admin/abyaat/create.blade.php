                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> إضافة  أبيات شعرية
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  إضافة أبيات شعرية</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.abyaat.store',$word->word_id)}}"
                                              method="POST">
                                              {{ csrf_field() }}
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> ادخال أبيات شعرية للكلمة  </h4>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                    ...
                                                                    <select name="poet_id" class="select2 form-control" id="selectId">
                                                                        <optgroup label="الشاعر">
                                                                            @foreach ($poets as $poet)
                                                                                    <option value="{{$poet->id}}">{{$poet->poet_name}}</option>
                                                                                    @endforeach
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label for="projectinput1">   بيت الشعر  </label>
                                                                    <textarea type="text" value="" id="bayt[]"
                                                                           class="form-control"
                                                                           placeholder=" "
                                                                           name="bayt[]"></textarea>
                                                                           @error("bayt.*")
