        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center">
                    <img src="{{asset('assets/'.$wisdoms[0]->character->character_photo)}}" alt="alt text" height="150" width="150"  class="rounded-circle">
                    <h4>{{$wisdoms[0]->character->character_name}}
                        </h4>
                        <p>{{$wisdoms[0]->character->about_character}}</p>
                    </div>
            </div>
            <div class="col-lg-8">
