                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة شخصية </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.characters.store')}}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="" id="character_name"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                           name="character_name">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea type="text" value="" id="about_character"
                                                                           class="form-control"
                                                                           placeholder=" "
                                                                           name="about_character"></textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="character_type" class="select2 form-control" id="selectId">
                                                                        <optgroup label=" نوع الكلمة ">
                                                                                    ...
                                                                                    <option value="0">الصحابة والتابعين</option>
