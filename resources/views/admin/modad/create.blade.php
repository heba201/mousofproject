                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> أضداد  </a>
                                </li>
                                <li class="breadcrumb-item active"> إضافة أضداد
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة أضداد  </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.modad.store',['id'=>$word->id,'mojjam_id'=>$mojjam->id])}}"
                                              method="POST">
                                              {{ csrf_field() }}
